...
return [
    ...
    |
    */
    'default' => env('IMAP_DEFAULT_ACCOUNT', 'monitor'),
    ...
    */
    'accounts' => [
        ...
        'monitor' => [
            'name'        => 'monitor',
            'host'        => env('IMAP_HOST', 'mxscan.me'),
            'port'        => (int) env('IMAP_PORT', 993),
            'protocol'    => 'imap',
            'encryption'  => env('IMAP_ENCRYPTION', 'ssl'), // ssl|tls|null
            'validate_cert' => false, // Set to false for self-signed certs
            'username'    => env('IMAP_USERNAME', 'monitor@mxscan.me'),
        ...
        'dmarc' => [
            'name'        => 'dmarc',
            'host'        => env('DMARC_IMAP_HOST', 'localhost'),
            'port'        => (int) env('DMARC_IMAP_PORT', 993),
            'protocol'    => 'imap',
            'encryption'  => env('DMARC_IMAP_ENCRYPTION', 'ssl'), // ssl|tls|null
            'validate_cert' => true,
