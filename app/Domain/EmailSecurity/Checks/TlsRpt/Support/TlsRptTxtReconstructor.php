 ...
 */
final class TlsRptTxtReconstructor
{
    private const VERSION_PREFIX = 'v=TLSRPTv1';
    ...
    public static function isTlsRptVersionToken(string $txt): bool
    {
        $txt = ltrim($txt);
     ...
     * @return list<string>
     */
    public static function selectTlsRptRecords(array $txtValues): array
    {
        return array_values(array_filter(
            $txtValues,
            fn (string $txt) => self::isTlsRptVersionToken($txt),
        ));
    }
}
