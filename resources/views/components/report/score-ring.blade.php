...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center text-center lg:items-start lg:text-left']) }}>
    <div class="relative h-40 w-40" role="img" aria-label="Email security score: {{ $score ?? 'unavailable' }} out of 100">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center">
            <div class="text-5xl font-bold leading-none text-gray-900">{{ $score ?? '—' }}</div>
