...
class TechnicalChecksRefinementTest extends TestCase
{
    ...
    public function test_missing_spf_renders_sender_confirmation_and_solution_builder(): void
    {
        ...
        $this->assertStringContainsString('Yes, it sends email', $spfSection);
        $this->assertStringContainsString("I'm not sure", $spfSection);
        $this->assertStringNotContainsString('Yes, authorize it', $spfSection);
